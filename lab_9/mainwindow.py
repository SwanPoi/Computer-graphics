...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "Многоугольник"))
        self.label_3.setText(_translate("MainWindow", "Отсекатель"))
        self.label_2.setText(_translate("MainWindow", "<html><head/><body><p>ЛКМ - точка отсекателя</p><p>ПКМ - добавление точки многоугольника</p><p>Shift+КМ - замыкание</p></body></html>"))
        ...
        self.add_point_pushButton.setText(_translate("MainWindow", "Добавить точку многоугольника"))
        ...
        self.final_cut_pushButton.setText(_translate("MainWindow", "Замкнуть отсекатель"))
        self.color_cut_pushButton.setText(_translate("MainWindow", "Цвет отсекателя"))
        self.color_segment_pushButton.setText(_translate("MainWindow", "Цвет многоугольника"))
