...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout.addWidget(self.felay_label, 0, 0, 1, 3)
        ...
        self.gridLayout.addWidget(self.without_delay_pushButton, 1, 2, 1, 1)
